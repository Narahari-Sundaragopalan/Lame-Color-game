...
function showWeather(lat, long) {
  var api_url = `https://api.darksky.net/forecast/f672ff13193bfcc40427a678ebfdbc71/${lat},${long}` + `?format=jsonp&callback=displayWeather`;
...
function farenheitToCelsius(k) {
  return Math.round((k - 32) * 0.05556); 
}
